...
const OrderHistory = () => {
  ...
  const getStatusBadge = (orderDate) => {
    ...
    if (diff < 30)
      return {
        ...
        icon: (
          <span className="w-2 h-2 bg-blue-500 rounded-full animate-pulse inline-block mr-1"></span>
        ),
      };
    if (diff < 60)
      return {
        ...
        icon: (
          <span className="w-2 h-2 bg-yellow-500 rounded-full animate-pulse inline-block mr-1"></span>
        ),
      };
    return {
      label: "Delivered",
      ...
      >
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-500 mb-8 leading-relaxed">
            Looks like you haven't placed any orders with SmartBite yet. Browse
            our delicious menu and treat yourself!
          </p>
          <Link
            to="/menu"
    ...
    <div className="max-w-5xl mx-auto py-4 md:py-10 px-4 sm:px-6">
      ...
      >
        ...
        <p className="text-gray-600">
          Keep track of all your delicious SmartBite meals and reviews
        </p>
      </motion.div>
      ...
      <div className="space-y-8">
        {orders.map((order, index) => {
          const status = getStatusBadge(order.OrderDate);
              ...
              <div className="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-200">
                <div className="flex flex-wrap justify-between items-center gap-3">
                  ...
                  <div className="flex gap-3 items-center">
                    <span
                      className={`text-sm md:text-sm font-medium px-3 py-1.5 rounded-full flex items-center whitespace-nowrap ${status.color}`}
                    >
                ...
                <div className="mb-2 md:mb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
                    {order.Items?.map((item, i) => {
                      ...
                      const existingReview = getExistingReview(dishId);
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <h5 className="text-sm md:text-xl font-medium text-gray-800 mb-1">
                              {item.name || item.Name}
                            </h5>
                            <div className="flex justify-between text-sm text-gray-600 mb-2">
                              <span className="bg-white text-xs md:text-sm px-2 py-0.5 rounded border border-gray-200">
                                Qty: {item.quantity || item.Quantity}
                              </span>
                              <span className="font-semibold text-xs md:text-sm items-center justify-center text-red-600">
                                ₹
