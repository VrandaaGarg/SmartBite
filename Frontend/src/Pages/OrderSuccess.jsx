...
const [order, setOrder] = useState(null);
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6">
        ...
        <div className="bg-red-600 text-white px-6 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-red-100">{new Date(order.createdAt).toLocaleString()}</p>
            </div>
        ...
        <div className="p-6 grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 mt-4">
              <div className="bg-red-600 h-2 rounded-full animate-pulse" style={{ width: "15%" }}></div>
            </div>
      ...
      >
        <p>
          Need help with your order? <a href="/support" className="text-red-600 hover:underline">Contact support</a>
        </p>
      </div>
    </div>
  );
