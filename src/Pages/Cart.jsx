...
import { FaShoppingCart, FaTrashAlt, FaArrowRight, FaPlus, FaMinus } from "react-icons/fa";
...
const Cart = () => {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center px-4 py-12 animate-fadeIn">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-700 mb-2">Your cart is empty</h2>
          <p className="text-gray-500 max-w-md mx-auto mb-8">
            Looks like you haven't added anything to your cart yet. 
            Browse our delicious menu and discover your new favorites.
          </p>
          <Link
            to="/menu"
        ...
        <div className="max-w-lg w-full mt-12">
          <h3 className="text-lg font-semibold text-gray-700 mb-3">Recommended for you</h3>
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-8 pb-20">
      <h1 className="text-3xl md:text-4xl font-bold text-center md:text-left mb-2 md:mb-6 text-red-600">Your Cart</h1>
      <p className="text-gray-500 text-center md:text-left mb-8">{cart.length} item(s) in your cart</p>
