...
const Home = () => {
  ...
  // Get top 4 dishes for customer favorites section
  const topDishes = dishes.slice(0, 4).map((dish) => ({
    id: dish.DishID,
    name: dish.Name,
      ...
      <section className="relative py-20 bg-gradient-to-br from-red-800 to-red-700 text-white px-4 overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-rose-100 animate-fade-in-up">
            Enjoy authentic Indian cuisine, from spicy starters to rich curries
            and aromatic biryanis – all made with love and delivered with care.
          </p>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-amber-50 to-rose-50">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <span className="bg-red-100 text-red-800 rounded-full px-4 py-1 text-sm font-medium">
              Why Choose Us
            </span>
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              At SmartBite, we're committed to bringing you the authentic taste
              of India with the convenience of modern delivery.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              ...
              className="rounded-lg shadow-lg odd:translate-y-4"
            />
            <img
              src="https://images.unsplash.com/photo-1613545325278-f24b0cae1224"
              alt="Indian curry"
              className="rounded-lg shadow-lg even:-translate-y-4"
            />
            <img
      ...
      <section className="py-16 bg-gradient-to-r from-red-800 to-red-700 text-white px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-rose-100 mb-8 max-w-2xl mx-auto">
            Order now and experience the authentic flavors of India delivered
